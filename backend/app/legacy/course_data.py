...
def _green_edges(
    tee: dict[str, float], green_center: dict[str, float]
...
_RAW: list[tuple] = [
    (
        ...
        -96.85123,
        [],
        "Long par 5 — favor position off the tee; avoid short-siding the green.",
    ),
    (
        2,
        4,
        ...
        -96.8543173,
        [],
        "Par 4 — play to the wide side of the fairway and take dead aim on the approach.",
    ),
    (
        3,
        4,
    ...
    (
        ...
        -96.8560858,
        [],
        "Par 3 — pick club for the full carry; center of the green is a good miss.",
    ),
    (
        5,
        4,
        ...
        -96.857377,
        [],
        "Strong par 4 — placement off the tee sets up the best angle into the green.",
    ),
    (
        6,
        5,
